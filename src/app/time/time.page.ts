...
export class TimePage implements OnInit {
  ...
  onSlideChange(swiper) {
    ...
    if(0.36*width<match && match<0.5*width){
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(46.6%, 0px, 0px);"
    ...
    //二
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(32.2%, 0px, 0px);"
    ...
    // 三
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(18.56%, 0px, 0px);"
    ...
    // 四
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(4.693%, 0px, 0px);"
    ...
    // 五
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(-9.6%, 0px, 0px);"
    ...
    // 六
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(-23.9%, 0px, 0px);"
    ...
    // 日
      ...
      swiper.$wrapperEl[0].attributes[4].value="transition-duration: 300ms; transform: translate3d(-37.76%, 0px, 0px);"
